...
/**	$servername = "localhost";
	...
	$sel="select * from faculty  WHERE unameff='$name'";
...
<button' name='pro' id='pro' style='width:auto; margin-left:100px;' ><a href='pro.php'><font size='+2' color='red' ><center><strong>UPDATE PHOTO</strong></center></font></a></button>       
<button' name='BACK' id='BACK' style='width:auto; margin-left:200px;' ><a href='faculty.php'><font size='+2' color='red' ><center><strong>BACK</strong></center></font></a></button> 
      <div  class='form'>
    		<form id='contactform' method='POST' action='sssss.php'> 
    			...
    			<input id='unamef' name='unamef' placeholder='username' required='' type='text' tabindex='1' value=".$unamef." readonly='' 
...
<input id='mobile' name='mobile' placeholder='phone number' required='' type='text' onKeyDown='myFunction()' tabindex='1' 
value=".$mobile." pattern='[0-9]+'  maxlength='10' minlength='10'><br>
		...
		<input type='date' id='date' name='date' required='' value=".$date."><br>
		 ...
		 <select class='select-style gender' name='dept' id='dept'>
  		 ...
  		 <label>Gender</label><br>
			...
			<input type='hidden' alt='unam' name='namee' value='$name' id='namee' >
