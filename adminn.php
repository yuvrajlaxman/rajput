...
<div class="f22 circle" style=" border:none; width:8%; height:100%; overflow: hidden; display: block; clear: both; float:left;" bgcolor="#3"></div>
	 <h4 align="left"><font style="color:red ; margin-left:30px; float:left;" >  <?php  echo("ADMIN"); ?> </font></h4>
	  <h3 align="left"><font style="color:white ; margin-left:285px;">  <?php  echo("SIR PADAMPAT SINGHANIA UNIVERSITY"); ?> 	 </font></h3>		
  ...
  <div class="container">
   ...
   <div class="form-group">
    ...
    <div class="input-group" style="height:20%;">
     ...
     <input type="text" name="search_text" id="search_text" placeholder="Search Student Information" class="form-control" />
    </div>
