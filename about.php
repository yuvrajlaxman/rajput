...
<font color="blue" > <h1 align="center"> About our project</font><br>
</h1>
<font color="white">

<h2>

<font color="red">*</font> As we know many institution are currently using the manual mode of handling the information<br>
 in which work carries in two phases as at first phase taking the information<br>
 in the sheet manually and in the second phase details are entered <br>
 and at last the reports are generated manually which might have errors.<br> <br><br>
<font color="red">*</font> Student Management System is the software developed for daily student information in colleges, schools etc.<br> 
 It manages the information about the students. <br><br><br>
<font color="red">*</font> There are two types of users available in the project, first one is department and second one is Admin.<br>
 Department user will have limited access right to access the system, <br>
 while the admin users have full control over the system.<br>
</h2>
</font>
</td>
</tr>
