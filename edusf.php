...
<div class='container'>
	...
	<BR><BR><h1 class='h' align='CENTER'><font color='BLACK' ALIGN='CENTER' size='+4'>EDUCATION DETAILS </font> </h1><BR><BR>
...
echo"<center><br><br><input type='submit' formaction='serchf.php' value='BACK' style='width:150px; height:40px; text-align:top'; class='button2'></center></form></body></html>";
}
?>
